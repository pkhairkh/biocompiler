...
try:
    import biocompiler.immunogenicity.mhcflurry_population as _mod
...
class TestGetAlleleFrequencyLogic:
    ...
    def test_zero_frequency_allele_population(self):
        """Some alleles have 0.5% in some populations — verify it is returned correctly."""
...
class TestInternalHelpers:
    ...
    def test_compute_global_coverage_empty_alleles(self):
        ...
        # but let us test _compute_global_coverage directly
