...
class TestArgumentParsing:
    ...
    def test_optimize_basic(self):
        ...
        # positional arg is 'protein', not 'input'
    ...
    def test_optimize_invalid_species(self):
        ...
        parser = build_parser()
        # species is no longer validated at parse time
...
class TestColorHelpers:
    ...
    def test_colorize_no_tty(self):
        ...
        with patch("biocompiler.cli.formatters.supports_color", return_value=False):
            result = colorize("hello", "\033[31m")
            assert result == "hello"

    def test_colorize_with_tty(self):
        """colorize should wrap text with ANSI codes when TTY."""
        with patch("biocompiler.cli.formatters.supports_color", return_value=True):
            result = colorize("hello", "\033[31m")
