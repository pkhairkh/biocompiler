...
from biocompiler.annotation import (
    SequenceAnnotation,
    annotate_sequence,
    annotate_to_genbank,
    _find_orfs,
...
class TestFindRestrictionSites:
    ...
    def test_no_sites_in_simple_sequence(self):
        ...
        sites = _find_restriction_sites(seq)
        # ATATAT doesn't match any 6-cutter; may or may not find sites
...
class TestFindSimpleRepeats:
    ...
    def test_no_repeat_in_random_sequence(self):
        ...
        repeats = _find_simple_repeats(seq)
        # May have some short repeats, but shouldn't be many
...
class TestFindRBS:
    ...
    def test_no_rbs_without_atg(self):
        """No RBS found when there's no ATG."""
