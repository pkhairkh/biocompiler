...
class TestModuleImport:
    ...
    def test_module_importable(self):
        ...
        import biocompiler.biopython_compat as mod  # noqa: F401
...
class TestToSeqrecordSignature:
    ...
    def test_sequence_is_required_positional(self):
        """The ``sequence`` parameter has no default (required)."""
        import biocompiler.biopython_compat as mod
        import inspect

        sig = inspect.signature(mod.to_seqrecord)
        assert sig.parameters["sequence"].default is inspect.Parameter.empty
...
class TestFromSeqrecordFunctional:
    ...
    def test_returns_dict(self, sample_dna):
        ...
        from biocompiler.biopython_compat import from_seqrecord, to_seqrecord
    ...
    def test_unknown_organism_default(self):
        ...
        from biocompiler.biopython_compat import from_seqrecord
