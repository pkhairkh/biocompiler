...
class TestSeverityEstimation:
    ...
    def test_severity_zero_when_no_positions(self):
        """If no positions are violated (should not normally happen through enforce),
