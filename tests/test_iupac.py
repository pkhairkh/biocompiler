...
from biocompiler.shared.constants import VALID_IUPAC_BASES as CONSTANTS_VALID_IUPAC_BASES
...
class TestResolveAmbiguous:
    ...
    def test_gc_balanced_strategy(self):
        # For a sequence that is all GC-balanced targets, should pick to keep GC ~50%
...
class TestInvariants:
    ...
    def test_complement_of_iupac_code_is_valid(self):
        ...
        from biocompiler.shared.constants import COMPLEMENT
