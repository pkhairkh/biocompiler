...
class TestCombineVerdicts:
    ...
    def test_any_likely_fail_yields_likely_fail_or_worse(self):
        """LIKELY_FAIL is the weakest unless there is an actual FAIL."""
...
class TestVerifyFiveValuedSoundness:
    ...
    def test_uncertain_always_sound(self):
        """UNCERTAIN makes no definite claim, so it is always sound."""
...
class TestEdgeCases:
    ...
    def test_confidence_sum_is_not_one(self):
        """Confidence scores do not sum to 1.0 (they are not probabilities)."""
