...
class TestSynonymousGCChange:
    ...
    def test_synonymous_can_change_gc_content(self, data):
        ...
        # We do not assert they ALWAYS differ, just that they CAN differ
...
class TestWobbleAnalysis:
    ...
    def test_valine_wobble_cannot_eliminate_gt(self):
        ...
        """
        for codon in AA_TO_CODONS["V"]:
            # GT is at positions 0-1, so changing position 2 does not help
            assert codon[0:2] == "GT", f"Valine codon {codon} does not start with GT"
