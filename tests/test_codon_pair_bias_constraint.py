...
def _import_e_coli():
    """Import e_coli organism module."""
    try:
        from biocompiler.organisms import e_coli
        return e_coli
    except ImportError as exc:
        pytest.skip(f"organisms.e_coli not available: {exc}")
...
class TestBuildCSPModelIntegration:
    ...
    def test_cpb_not_added_for_organism_without_data(self):
        ...
        # We can't pass an unknown organism to build_csp_model (it validates),
