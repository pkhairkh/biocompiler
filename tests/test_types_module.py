"""
Tests for biocompiler.shared.types — the canonical core types module.
...
# _VERDICT_ORDER is an internal implementation detail, no longer in __all__.
...
class TestPositionRange:
    ...
    def test_overlaps_false_adjacent(self):
        """Adjacent half-open intervals do not overlap: [0,10) and [10,20)."""
        pr1 = PositionRange(start=0, end=10)
...
class TestModuleExports:
    ...
    def test_all_names_importable(self):
        ...
        import biocompiler.shared.types as types_mod
        for name in types_all:
