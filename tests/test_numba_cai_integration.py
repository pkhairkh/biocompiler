...
class TestAdaptivenessToArray:
    ...
    def test_missing_codons_get_epsilon(self):
        ...
        # Check a codon that's NOT in the dict
...
class TestFullOptimizationCAI:
    ...
    def test_numba_kernel_available(self):
        ...
        # This test just reports the status — it's not a pass/fail
        if HAS_NUMBA:
...
class TestCAIRegression:
    """Regression tests to ensure NUMBA integration doesn't change results."""
