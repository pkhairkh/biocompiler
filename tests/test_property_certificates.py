...
from biocompiler.shared.types import Verdict, TypeCheckResult, Certificate
...
class TestMonotonicity:
    ...
    def test_removing_failures_can_only_raise_level(self, results):
        ...
        if not passing_only:
            # Cannot have empty results, skip
...
class TestExhaustiveness:
    ...
    def test_certificate_levels_are_mutually_exclusive(self, results):
        ...
        # It is exactly one (enum guarantees this, but we verify)
