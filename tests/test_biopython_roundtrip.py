"""Tests for BioPython round-trip compatibility — 1.0.0 additions.
...
# The module-level ``pytest.importorskip("Bio")`` below already skips the
# file when BioPython is absent; the marker keeps these tests deselected by
# default alongside other requires_external tests for consistency.
...
class TestOptimizeSeqrecord:
    ...
    def test_returns_seqrecord(self, sample_protein):
        ...
        from biocompiler.infrastructure.biopython_compat import optimize_seqrecord
    ...
    def test_value_error_on_empty_sequence(self):
        """optimize_seqrecord raises error if the record cannot be translated."""
        from biocompiler.infrastructure.biopython_compat import optimize_seqrecord
...
class TestFromSeqio:
    ...
    def test_from_fasta_file(self, tmp_path):
        ...
        from biocompiler.infrastructure.biopython_compat import from_seqio
    ...
    def test_from_genbank_file(self, tmp_path):
        ...
        from biocompiler.infrastructure.biopython_compat import from_seqio, to_seqrecord, to_genbank_string
...
class TestToGenbankString:
    ...
    def test_returns_string(self, sample_dna):
        ...
        from biocompiler.infrastructure.biopython_compat import to_seqrecord, to_genbank_string
    ...
    def test_molecule_type_auto_added(self, sample_dna):
        ...
        from biocompiler.infrastructure.biopython_compat import to_genbank_string
...
class TestToFastaString:
    ...
    def test_returns_string(self, sample_dna):
        ...
        from biocompiler.infrastructure.biopython_compat import to_seqrecord, to_fasta_string
