...
Covers four core properties:
  ...
  3. For any valid DNA sequence, type checking doesn't raise exceptions
  4. combined_verdict returns a valid Verdict
"""

from hypothesis import given, strategies as st, assume, settings

from biocompiler.types import Verdict, TypeCheckResult, combined_verdict
...
# ────────────────────────────────────────────────────────────
# Property 3: For any valid DNA sequence, type checking doesn't raise exceptions
# ────────────────────────────────────────────────────────────
