"""
Unit tests for biocompiler.optimizer.constraint_helpers — restriction site removal,
...
from biocompiler.optimizer.constraint_helpers import (
...
class TestRemoveSiteMulticodon:
    ...
    def test_remove_site_within_codon(self):
        ...
        # We need correct aas. Let us compute them.
