...
def assert_no_regression(
    ...
    """Assert that current performance hasn't regressed relative to baseline.
...
class TestCIEnvironmentResources:
    ...
    def test_memory_available(self):
        ...
        We don't set a hard minimum, but verify we can query memory info.
        """
        try:
            import resource
            ...
            # Just verify it's a reasonable number (not negative, not absurd)
