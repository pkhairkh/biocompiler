...
Tests cover:
1. CAIAwareConstraintResolver — estimate_cai_impact and rank_resolution
...
class TestProvenanceCAIAware:
    ...
    def test_provenance_with_cai_aware_records(self, gc_constraint, cpg_constraint):
        """CAI-aware provenance should record cai_impact from CAIAwareConstraintResolver."""
