...
class TestFallbackToPSSM:
    ...
    def test_predict_mhc_i_falls_back_on_api_failure(self, mock_urlopen):
        ...
        from biocompiler.immunogenicity.core import predict_mhc_i_binding, clear_cache
        clear_cache()
        ...
        # (even if some peptides do not match PSSM length)
    ...
    def test_predict_mhc_ii_falls_back_on_api_failure(self, mock_urlopen):
        ...
        from biocompiler.immunogenicity.core import predict_mhc_ii_binding, clear_cache
        clear_cache()
    ...
    def test_predict_all_falls_back_on_api_failure(self, mock_urlopen):
        ...
        from biocompiler.immunogenicity.core import predict_all, clear_cache
        clear_cache()
