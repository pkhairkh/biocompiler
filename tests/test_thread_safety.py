...
class TestSharpLiAdaptivenessTables:
    ...
    don't corrupt data or raise exceptions."""
...
class TestRandomSeedIsolation:
    ...
    def test_seed_does_not_pollute_global_random(self):
        ...
        # instead of random.seed(). Verify the module doesn't call random.seed().
        from biocompiler.optimization import _greedy_optimize

        # _greedy_optimize accepts seed; verify it doesn't call random.seed()
...
class TestLazyInitThreadSafety:
    ...
    def test_esmfold_cache_init(self):
        ...
        from biocompiler.esmfold import _get_default_cache
        # Reset
        import biocompiler.esmfold as esm_mod
    ...
    def test_netmhcpan_cache_init(self):
        ...
        # Reset
        import biocompiler.netmhcpan as nm_mod
    ...
    def test_proof_checks_valine_concurrent(self):
        ...
        from biocompiler.proof_checks import assert_valine_gt_invariant
    ...
    def test_immunogenicity_pssm_concurrent_build(self):
        ...
        from biocompiler.immunogenicity import _ensure_pssms_built
        # Reset to force rebuild
        import biocompiler.immunogenicity as imm_mod
...
class TestCacheClearThreadSafety:
    ...
    def test_immunogenicity_clear_cache_concurrent(self):
        ...
        from biocompiler.immunogenicity import clear_cache
        errors: list[Exception] = []
