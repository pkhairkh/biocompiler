"""Unit tests for foldx.py that do not require FoldX installation.
...
from biocompiler.engines.base import BaseEngineResult, BatchResult
...
class TestFunctionExistence:
    ...
    def test_public_function_importable(self, name: str) -> None:
        ...
        import biocompiler.engines.foldx as mod
...
class TestClassExistenceAndFields:
    ...
    def test_mutation_result_is_engine_base_mutation_result(self) -> None:
        ...
        from biocompiler.engines.base import MutationResult as BaseMR
...
class TestFoldXMutationFallback:
    ...
    def test_returns_empty_list_for_empty_mutations(self) -> None:
        ...
        # Do not even need to mock availability — empty list is early return
...
class TestModuleCache:
    ...
    def test_clear_cache_resets_module_cache(self) -> None:
        ...
        clear_cache()
        from biocompiler.engines.foldx import _cache
        assert len(_cache) == 0
