...
class _FakeOptimizationResult:
    """Minimal stand-in for biocompiler.optimizer.OptimizationResult."""
...
_OPTIMIZE_PATCH = "biocompiler.optimizer.optimize_sequence"
...
class TestBenchmarkRuns:
    ...
    def test_run_with_nonexistent_genes(self) -> None:
        ...
        # The gene will not be found, so panel is empty
        assert result.num_genes == 0
