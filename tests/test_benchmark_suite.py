...
class TestRegressionDetection:
    ...
    def test_compare_single_metric_gc_regression(self):
        ...
        # means we skip (cannot compute percentage of zero)
    ...
    def test_compare_single_metric_zero_baseline(self):
        ...
        assert reg is None  # Cannot compute % change from zero
    ...
    def test_compare_results_no_regressions(self):
        ...
        current = BenchmarkRunResult(
            suite_name="core", version="1.0.0", results=results,
        )
        baseline = BenchmarkRunResult(
            suite_name="core", version="1.0.0", results=list(results),
        )
    ...
    def test_compare_results_with_cai_regression(self):
        ...
        baseline = BenchmarkRunResult(
            suite_name="core", version="1.0.0", results=baseline_results,
        )
        current = BenchmarkRunResult(
            suite_name="core", version="1.0.0", results=current_results,
        )
