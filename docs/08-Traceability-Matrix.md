...
| Requirement | Summary | Component (DOC-02) | Design Section (DOC-03) | Interface (DOC-04) | Unit Test(s) | Integration Test(s) | System Test(s) | Soundness Test(s) | Risk(s) |
|---|---|---|---|---|---|---|---|---|---|
| REQ-FUNC-030 | Type checker with three-valued verdicts (PASS/FAIL/UNCERTAIN; full Python system uses five-valued logic); no probabilities | COMP-05 (Type System) | §3.5 COMP-05: Type System | IF-05 (Type System Interface) | TC-U-030, TC-U-031 | TC-I-004 | TC-S-001 | TC-SND-001, TC-SND-002, TC-SND-003, TC-SND-004, TC-SND-005, TC-SND-006 | RISK-03 |
| REQ-FUNC-031 | 36 type predicates (17 core + 19 SLOT-dependent); see DOC-15 §1 for the full predicate registry | COMP-05 (Type System) | §3.5 COMP-05: Type System | IF-05 (Type System Interface) | TC-U-030, TC-U-031 | TC-I-004 | TC-S-001 | TC-SND-001, TC-SND-002, TC-SND-003, TC-SND-004, TC-SND-005, TC-SND-006, TC-SND-007 | — |
...
| REQ-FUNC-072 | Three-valued verdicts for composition checks with evidence (full Python system uses five-valued logic) | COMP-08 (Compositional Verifier) | §3.8 COMP-08: Compositional Verifier | IF-08 (Composition Interface) | TC-U-070, TC-U-071, TC-U-072, TC-U-073 | TC-I-008 | TC-S-002 | — | — |
| REQ-FUNC-073 | Composition via three-valued logic (Lean4 formal model; full system uses five-valued composition): AND of individual gene verdicts and composition check verdicts | COMP-08 (Compositional Verifier) | §3.8 COMP-08: Compositional Verifier | IF-08 (Composition Interface) | TC-U-070, TC-U-071, TC-U-072, TC-U-073 | TC-I-008 | TC-S-002 | — | RISK-08 |
...
| REQ-NFR-004 | Type checker: ≤ 10 s for all 36 predicates (17 core + 19 SLOT-dependent) on single mRNA on single CPU core | Performance benchmark | TC-U-030 (timing), TC-I-004 (timing) | — |
