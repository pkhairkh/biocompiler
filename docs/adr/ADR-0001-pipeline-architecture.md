...
> **Note:** The typed IR layer (IR-Seq, IR-Peptide, IR-Structure, IR-Circuit) described in this ADR was NOT implemented. The pipeline uses simple Python dataclasses (Token, SpliceIsoform, TypeCheckResult, Certificate) passed as function arguments.
