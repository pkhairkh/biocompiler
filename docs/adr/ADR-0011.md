# ADR-0011: Predicate Checking Delegation (Separation of Concerns)
...
Additionally, the NoCrypticSplice predicate is updated to flag standalone strong donors and acceptors (not just pairs), aligning it with the optimizer's Phase 7 logic.
