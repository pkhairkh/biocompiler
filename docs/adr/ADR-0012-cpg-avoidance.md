...
Post-CpG reconciliation step adds reconciliation to ensure CpG fixes do not undo restriction site
...
highest-CAI alternative codon that eliminates the CG and does not violate constraints
...
- **Positive**: Post-CpG reconciliation step ensures that CpG fixes do not introduce
