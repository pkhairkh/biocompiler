/-
  ...
  Key properties (50 theorems total, 0 sorry, 0 axioms):
  ...
  5. De Morgan's laws, not involutive, absorption, distributivity
  6. Monotonicity of and/or (left and right)
  7. Projection properties and refinement theorems
  8. Foldl properties (PASS propagation, FAIL absorption)
  9. Bounded lattice: Top=PASS, Bottom=FAIL, Meet=and, Join=or
  10. Ordering theorems and discrimination lemmas
