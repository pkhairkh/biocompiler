...
lean_lib BioCompiler where
  roots := #[`BioCompiler.Soundness, `BioCompiler.ThreeValued, `BioCompiler.Sequence, `BioCompiler.NDFST, `BioCompiler.Scanners, `BioCompiler.ScannerProofs, `BioCompiler.OracleProofs, `BioCompiler.TypeSystem, `BioCompiler.Compositional, `BioCompiler.Certificates, `BioCompiler.SLOTIndependence, `BioCompiler.Mutagenesis, `BioCompiler.SplicingResolution, `BioCompiler.SLOTVerification]
