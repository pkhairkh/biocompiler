...
Usage:
    python scripts/build_blast_databases.py [--output-dir /path/to/dbs]
...
def main() -> None:
    ...
    from biocompiler.blast_integration import is_blast_available, build_hazard_db
    ...
    from biocompiler.blast_integration import _build_hazard_sequences_from_signatures
    ...
    if os.path.exists(ref_seqs_file):
        ...
        if ref_seqs:
            # Determine type based on content (heuristic: if all ACGT, it's DNA)
