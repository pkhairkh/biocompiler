...
class OrganismDatabase:
    ...
    def _ensure_schema(self) -> None:
        """Create database tables if they do not exist, with schema versioning."""
        conn = self._connect()
        try:
    ...
    def _get_schema_version(conn: sqlite3.Connection) -> int:
        ...
        try:
            ...
            # Table does not exist yet — old schema without versioning
    ...
    def _validate_codon_usage_data(
        ...
        Fixes:
        - Corrects amino acid assignments that do not match CODON_TABLE
    ...
    def _store_response_hash(self, organism: str, html: str, url: str) -> None:
        ...
        try:
            ...
            # Table may not exist in older schemas — log but do not fail
    ...
    def verify_cache_integrity(self, organism: str) -> bool:
        ...
        try:
            ...
            if not row:
                return True  # No hash stored — cannot verify, assume OK
