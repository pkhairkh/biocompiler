...
# ────────────────────────────────────────────────────────────
# BLOSUM62 Substitution Matrix (20x20, nested dict format)
# ────────────────────────────────────────────────────────────

_BLOSUM62_AAS = list("ARNDCQEGHILKMFPSTWYV")
...
for _i, _aa1 in enumerate(_BLOSUM62_AAS):
    BLOSUM62[_aa1] = {}
    for _j, _aa2 in enumerate(_BLOSUM62_AAS):
        BLOSUM62[_aa1][_aa2] = _BLOSUM62_ROWS[_i][_j]
