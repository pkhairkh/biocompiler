"""
BioCompiler FoldX Stability Analysis Module v1.0.0
====================================================
...
from biocompiler.shared.constants import BLOSUM62, HYDROPATHY, STANDARD_AAS, HYDROPHOBIC_AAS
from .base import (
    BaseEngineResult,
    BatchResult,
    EngineTimer,
...
try:
    from biocompiler.shared.exceptions import FoldXError
except ImportError:
...
try:
    from biocompiler.shared.constants import DEFAULT_ENGINE_TIMEOUT, DEFAULT_BATCH_SIZE
except ImportError:
...
_MAX_LENGTH_BONUS_ABS: float = 1.5         # cap: maximum stabilizing contribution from length
...
def empirical_stability(
    ...
    *,
    ...
    with EngineTimer() as timer:
        ...
        length_bonus = max(length_bonus, -_MAX_LENGTH_BONUS_ABS)
...
def run_stability_batch(
    ...
    **kwargs,
    ...
    # Replace any None entries with failed results (should not happen, but safety)
