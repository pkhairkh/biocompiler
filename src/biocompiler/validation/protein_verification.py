...
Usage::
    ...
    from biocompiler.validation.protein_verification import verify_translation
...
from biocompiler.shared.constants import CODON_TABLE, STOP_CODONS
...
def verify_translation(
    ...
    for i in range(num_codons):
        codon = dna[i * 3 : i * 3 + 3]
        if len(codon) < 3:
            break  # Partial codon at end — should not happen with valid input
