...
def load_codon_usage_table(
    ...
    if fasta_path is not None:
        ...
        # (BioPython's CodonAdaptationIndex does not always expose raw counts)
...
def detect_orfs(
    ...
    try:
        ...
        from biocompiler.expression.translation import find_orfs as _find_orfs, BACTERIAL_START_CODONS
        ...
        from biocompiler.expression.translation import find_orfs as _find_orfs
...
def blast_local(
    ...
    Args:
        ...
        blast_exe: Optional path to the BLAST executable. If ``None``,
            the program name is used directly (assumes it is on PATH).
...
def optimize_seqrecord(
    ...
    **kwargs,
    ...
    if record.letter_annotations:
        # Do not copy if they would be invalid (e.g. wrong length)
        pass
