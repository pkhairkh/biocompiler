...
Each entry is a dict with:
  category  : str   — hazard category (select_agent, australia_group,
                      viral_surface, antibiotic_resistance, oncogene)
...
_HAZARD_SIGNATURES: list[dict] = [
    ...
    # Botulinum neurotoxin (BoNT) — additional protein signatures covering
    # the HExxH zinc-binding motif (HELIH) and the catalytic E...H region.
    # The original 3 BoNT protein motifs above use a 10-aa window that does
    # not always occur in publicly released BoNT fragments — adding these
    # extended-context motifs improves coverage of reference fragments
    # (see data/hazard_reference_sequences.fasta).
    {
        "category": "select_agent",
        "name": "botulinum_zinc_HELIH",
        "motif": "PVHELIHAVL",
        "confidence": 0.92,
        "risk": "critical",
        "type": "protein",
        "source": "Lacy & Stevens, Nat Struct Biol 1999; 6(2):163-7 (HExxH zinc-binding motif, HELIH extended context)",
    },
    {
        "category": "select_agent",
        "name": "botulinum_catalytic_EIDH",
        "motif": "EIDYHQKLIV",
        "confidence": 0.85,
        "risk": "high",
        "type": "protein",
        "source": "Agarwal et al., Protein Sci 2008; 17(3):419-28 (catalytic E...H motif region)",
    },
    # Botulinum neurotoxin (BoNT) — additional DNA signatures covering
    # conserved coding regions.  These catch hazards that motif-based
    # protein screening may miss (e.g. wobble-position codon variants).
    # The 15-nt zinc-binding motif encodes HELIH (CAC=GAG=CTG=ATC=CAC).
    {
        "category": "select_agent",
        "name": "botulinum_zinc_dna",
        "motif": "CACGAGCTGATCCAC",
        "confidence": 0.92,
        "risk": "critical",
        "type": "dna",
        "source": "Lacy & Stevens, Nat Struct Biol 1999; 6(2):163-7 (BoNT HELIH zinc-binding DNA motif)",
    },
    {
        "category": "select_agent",
        "name": "botulinum_catalytic_dna",
        "motif": "GAGATCGACTATCAC",
        "confidence": 0.88,
        "risk": "critical",
        "type": "dna",
        "source": "Agarwal et al., Protein Sci 2008; 17(3):419-28 (BoNT catalytic EIDH DNA motif)",
    },
    {
        "category": "select_agent",
        "name": "botulinum_receptor_dna",
        "motif": "TGGACCTTGCCGACCAG",
        "confidence": 0.85,
        "risk": "high",
        "type": "dna",
        "source": "Swaminathan & Eswaramoorthy, Nat Struct Biol 2000; 7(8):693-9 (BoNT receptor-binding DNA motif)",
    },
    ...
    # Saxitoxin biosynthetic enzymes (Australia Group)
    {
        "category": "australia_group",
        "name": "sxtA_saxitoxin",
        "motif": "TQEGDAVKRY",
        ...
        "risk": "high",
        "type": "protein",
        "source": "Kellmann et al., Appl Environ Microbiol 2008; 74(12):3898-907 (sxtA catalytic domain)",
    },
    {
        "category": "australia_group",
        "name": "sxtG_saxitoxin",
        ...
        "risk": "high",
        "type": "protein",
        "source": "Murray et al., ChemBioChem 2011; 12(10):1544-52 (sxtG amidinotransferase)",
    },
    # Conotoxins (Australia Group + CDC Select Agent)
    {
        "category": "select_agent",
        "name": "alpha_conotoxin_GI",
        "motif": "GCCSHPACAG",
        "confidence": 0.85,
        "risk": "high",
        "type": "protein",
        "source": "Gray et al., J Biol Chem 1981; 256(10):4734-40 (alpha-conotoxin GI)",
    },
    {
        "category": "select_agent",
        "name": "omega_conotoxin_MVIIA",
        "motif": "CKGKGAKCSRL",
        "confidence": 0.83,
        "risk": "high",
        "type": "protein",
        "source": "Olivera et al., Science 1990; 249(4966):257-63 (omega-conotoxin MVIIA)",
    },
    # C. botulinum C2 toxin (CDC Select Agent)
    {
        "category": "select_agent",
        "name": "botulinum_C2_toxin",
        "motif": "NFIYFKKSSN",
        "confidence": 0.80,
        "risk": "high",
        "type": "protein",
        "source": "Barth et al., J Biol Chem 1998; 273(44):29506-11 (C2-II binding domain)",
    },
    # C. botulinum C3 toxin (CDC Select Agent)
    {
        "category": "select_agent",
        "name": "botulinum_C3_toxin",
        "motif": "SFSDPKQNVN",
        "confidence": 0.78,
        "risk": "high",
        "type": "protein",
        "source": "Aktories et al., Nature 1987; 329:738-40 (C3 ADP-ribosyltransferase)",
    },
    # C. perfringens epsilon toxin (Australia Group)
    {
        "category": "australia_group",
        "name": "perfringens_epsilon_toxin",
        "motif": "YNIYVKDYNI",
        "confidence": 0.82,
        "risk": "high",
        "type": "protein",
        "source": "Popoff, Toxicon 2011; 58(6-7):522-30 (epsilon toxin pore-forming domain)",
    },
    # Staphylococcal enterotoxin A (CDC Select Agent)
    {
        "category": "select_agent",
        "name": "staph_enterotoxin_A",
        "motif": "KFIENKHTKF",
        "confidence": 0.84,
        "risk": "high",
        "type": "protein",
        "source": "Harris et al., J Immunol 1993; 151(9):4966-77 (SEA TCR binding domain)",
    },
...
HAZARD_SIGNATURE_COUNT: int = len(_HAZARD_SIGNATURES)
