"""
BioCompiler Solubility Predicates v1.0.0
=========================================
...
def evaluate_soluble_expression(
    ...
    if camsol_score > _CAMSOL_HIGHLY_SOLUBLE:
        ...
        # If the protein has adequate net charge, it is more likely soluble
    ...
    # If the score is below the user-specified minimum, that is a stronger
    # failure signal
