...
Usage:
  from biocompiler.sequence.iupac import resolve_ambiguous, is_ambiguous, expand_ambiguous
...
def _resolve_cai_optimal(
    ...
    *,
    ...
    CAI. If the ambiguous base does not fall in a complete codon, fall
    back to most_common.
    """
