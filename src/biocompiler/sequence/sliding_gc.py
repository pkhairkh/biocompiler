...
try:
    from biocompiler.optimizer.numba_kernels import fast_gc_window as _fast_gc_window_numba
    from biocompiler.optimizer.numba_kernels import seq_to_bytes as _seq_to_bytes
    from biocompiler.optimizer.numba_kernels import HAS_NUMBA as _HAS_NUMBA
except ImportError:
