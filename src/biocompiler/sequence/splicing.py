...
def maxent_score_v2(context: str) -> float:
    ...
    """
    from .maxentscan import score_donor as _score_donor  # same-package import
...
from biocompiler.tissue_data import get_tissue_weights as _get_gtex_weights
...
def _get_tissue_weights(cellular_context: str) -> dict[str, float]:
    ...
    try:
        ...
        from biocompiler.tissue_data import GTEX_TISSUE_WEIGHTS
