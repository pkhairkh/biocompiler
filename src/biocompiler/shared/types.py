...
class Certificate:
    ...
    Attributes:
        ...
        hash_version: Version of the hash computation used for design_id.
            ...
            sorted predicate results + key optimization parameters (5 core
            params), 3 = extended hash covering ALL predicate-affecting
            parameters (C14 fix, _CURRENT_HASH_VERSION).
            Defaults to 3 (_CURRENT_HASH_VERSION) for new certificates;
            certificates deserialized from legacy data default to 1 for
