...
from biocompiler.sequence.scanner import gc_content, validate_dna_sequence
from biocompiler.sequence.restriction_sites import RESTRICTION_SITES, get_eliminable_sites
from biocompiler.shared.constants import CODON_TABLE, AA_TO_CODONS, reverse_complement, STOP_CODONS
...
def _find_orfs(dna: str) -> list[SequenceAnnotation]:
    ...
    from biocompiler.expression.translation import find_orfs as _find_orfs_bio
