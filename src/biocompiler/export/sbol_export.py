...
def export_sbol(
    ...
    Converts a BioCompiler :class:`~biocompiler.optimizer.OptimizationResult`
    ...
    Args:
        optimization_result: An :class:`~biocompiler.optimizer.OptimizationResult`
...
def export_sbol_collection(
    ...
    Args:
        results: List of :class:`~biocompiler.optimizer.OptimizationResult` objects.
        output_path: File path to write the SBOL document.
